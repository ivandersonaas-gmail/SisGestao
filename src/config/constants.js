...
export const FLOW = {
  ...
  EM_ANALISE:     {analyst:['PARECER','ANUENCIA','ANUENCIA_SOLO','TOPOGRAFIA','ENC_ASSINATURA','DEV_PROTOCOLO'],admin:['PARECER','ANUENCIA','ANUENCIA_SOLO','TOPOGRAFIA','ENC_ASSINATURA','DEV_PROTOCOLO'],secretary:['PARECER','ANUENCIA','ANUENCIA_SOLO','ENC_ASSINATURA']},
