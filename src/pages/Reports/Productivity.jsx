...
export function Productivity() {
  ...
  const waSendCustom = () => {
    ...
    const statusOrder = ['ENTRADA','ENC_ANALISE','RECEBIDO_SETOR','EM_ANALISE','TOPOGRAFIA','ENC_ASSINATURA','PARECER','ANUENCIA','ANUENCIA_SOLO','LIC_COND','ATO_APR','V2_ATO','V2_COND','DEV_PROTOCOLO_PARECER','DEV_PROTOCOLO_ANUENCIA','DEV_PROTOCOLO_ANUENCIA_SOLO','DEV_PROTOCOLO','DEV_REQUERENTE','RETORNO_REQ','ASSINADO','DISP_RETIRADA','FINALIZADO'];
    const emoji = {ENTRADA:'📥',ENC_ANALISE:'📤',RECEBIDO_SETOR:'📥',EM_ANALISE:'🔄',TOPOGRAFIA:'📐',ENC_ASSINATURA:'✍️',PARECER:'📝',ANUENCIA:'📌',ANUENCIA_SOLO:'📌',LIC_COND:'📌',ATO_APR:'📌',V2_ATO:'📌',V2_COND:'📌',DEV_PROTOCOLO_PARECER:'↩️',DEV_PROTOCOLO_ANUENCIA:'↩️',DEV_PROTOCOLO_ANUENCIA_SOLO:'↩️',DEV_PROTOCOLO:'↩️',DEV_REQUERENTE:'⏳',RETORNO_REQ:'🔄',ASSINADO:'✅',DISP_RETIRADA:'✅',FINALIZADO:'✅'};
